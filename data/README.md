...
FlowCyt is the first comprehensive benchmark for evaluating multi-class single-cell classification methods on flow cytometry data. It comprises a richly annotated dataset of bone marrow samples from 30 patients, with ground truth labels for 5 important hematological cell types. Pleaae, download the data directly from our [FlowCyt webpage](https://cuicloud.unige.ch/index.php/s/55PHBLEynrp5pN8) and follow the hereafter instructions.
